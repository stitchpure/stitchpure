ALTER TABLE "product_options" ADD COLUMN "slug" varchar(100) DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE "product_options" ADD COLUMN IF NOT EXISTS "is_active" boolean DEFAULT true NOT NULL;--> statement-breakpoint
